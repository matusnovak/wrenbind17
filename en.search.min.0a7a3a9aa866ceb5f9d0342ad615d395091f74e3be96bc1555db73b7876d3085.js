...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/wrenbind17/flexsearch.min.js');loadScript('/wrenbind17/en.search-data.min.04aabf2427f2b533095d66932e5deec3adb821b42ec7417c6163073a3b9d0a63.js',function(){input.required=false;search();});}
